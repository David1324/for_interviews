...
bool initSharedMem()
{
    ...
    std::cout << "Is Intersected: " << plane1.isIntersected(plane2) << std::endl;
    ...
    // load an obj model to draw the intersection line
    obj.read("cylinder.obj");
