...
function [ValidX,ValidY]=PickPeaksLine
    ...
    PeakSelection = menu(sprintf('How do you want to select the peaks?'),'Single Select', 'Automatically', 'Cancel');
    ...
    for CurrentPeak=1:NumOfPeaks
        ...
        % Fitting
        X=lsqcurvefit(@GaussOnePeak,[AmplitudeGuess PositionGuess WidthGuess BackgroundGuess],FitXData,FitYData);
