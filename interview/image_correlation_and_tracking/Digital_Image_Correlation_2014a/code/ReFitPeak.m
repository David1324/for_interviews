...
function [Beta,ResNorm,ExitFlag]=ReFitPeak(Beta,CropX,CropY,CroppedImage,FileName,DirectionSum,ShowFit,TotalTimeHours,EstimatedTotalTimeHours,TotalProgress)
    ...
    [Beta,ResNorm,~,ExitFlag]=lsqcurvefit(@GaussOnePeak,Beta,XData,YData);
