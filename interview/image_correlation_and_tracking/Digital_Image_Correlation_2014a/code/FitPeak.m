...
function [Beta,ResNorm,ExitFlag]=FitPeak(CroppedImage,DirectionPoints,CroppedLabelsXY,CurrentLabel,DirectionSum,ShowFit)
    ...
    % Fitting
    [Beta,ResNorm,~,ExitFlag]=lsqcurvefit(@GaussOnePeak,[AmplitudeGuess PositionGuess WidthGuess BackgroundGuess],XData,YData);
